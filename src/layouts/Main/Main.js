...
const Main = () => {
  ...
  const navItems = (
    <>
      ...
      }} to={'/contact-us'} className={"lg:mx-5 lg:my-0"}>
        <IconButton className={"w-full lg:w-auto my-2 lg:my-0"}>
          <MailIcon />
          Contact Us
        </IconButton>
      ...
      }} to={'/doc'} className={"lg:mx-5 lg:my-0"}>
        <IconButton className={"w-full lg:w-auto my-2 lg:my-0"}>
          <DocumentIcon />
          Documentation
        </IconButton>
      ...
      <div className="divider my-2"></div>
      {
        authUser?.email ?
          ...
          }} className="my-1 lg:hidden" to={"/signup"}>
  ...
  return (
    <div>
      ...
      <div className="drawer">
        <input ref={drawerToggleRef} id="mainDrawer" type="checkbox" className="drawer-toggle lg:hidden" />
